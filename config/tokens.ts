...
const config: {
  ...
  wannsee: {
    WMXC: {
      ...
      decimals: 18,
      wrappedNative: true,
      realtimeFeedId: "0xbe1662b74562d1bd1f7b33e8b79894e93762180a966346c1c031061a9ee8e9ca", // hashString("WMXC")
      realtimeFeedDecimals: 8,
      transferGasLimit: 200 * 1000,
    },
    DG: {
      address: "0xdCc959e6e731b1CcA695a9e28D39103Bd0ecdb05",
      decimals: 18,
      realtimeFeedId: "0x95024d9de11a92bcf131e8b00da9c535b52d76742c5c4d1532fb9842d8321c9a", // hashString("DG")
      realtimeFeedDecimals: 8,
      transferGasLimit: 200 * 1000,
    },
  },
